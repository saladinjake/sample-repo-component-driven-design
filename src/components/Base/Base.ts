...
import { responsiveQueriesFluxMapper, getFloatingWidthValue,  singleCssStylePropsMapper } from './util'
import libraryConfig from '../../libraryConfig'
import IBaseProps from './Base.types'
 
  /*
     ${props => singleCssStylePropsMapper(props)}
  */

const { spacing, perimeters } = libraryConfig

const blackListsCases = [
  'margin-top',
  'margin-right',
  'margin-left',
  'margin-bottom',
